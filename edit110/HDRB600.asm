        TTL     Header file HI-Edit (CMOS)      > HDRB600


        ORG     &B600   ; Object destination address

        ; ------------------------------------------------------------ ;

        GBLS    $vers
$vers   SETS    "1.23"  ; No more than 4 characters please
...
extgf   *       1       ; extended FIND/REPLACE texts
